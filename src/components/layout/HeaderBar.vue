...
import { Dismiss16Regular, Settings16Regular, Subtract16Regular } from "@vicons/fluent";
...
function initWait() {
	leaveWait.value.wait = new Promise((resolve) => (leaveWait.value.done = resolve));
}
				...
				<template #action>
					<div class="flex flex-row justify-between items-center">
						...
						<n-space>
							...
							<n-button type="primary" @click="handleCloseConfirm">确认</n-button>
						</n-space>
					</div>
				</template>
			</n-card>
